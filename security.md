...
pandoc security.md -s --toc=true -o security.html
- change nav to aside
- add id to first ul

Heading anchors generated by https://bitdowntoc.derlin.ch/
 -->

<aside id="TOC" role="doc-toc">
  <h1>Contents</h1>
<ul id="main">
<li><a href="#known-cryptpad-security-issues"
id="toc-known-cryptpad-security-issues">Known CryptPad security
issues</a></li>
<li><a
href="#what-are-the-available-channels-to-discuss-security-issues"
id="toc-what-are-the-available-channels-to-discuss-security-issues">What
are the available channels to discuss security issues?</a>
<ul>
<li><a href="#github-security-advisories"
id="toc-github-security-advisories">GitHub security advisories</a></li>
</ul></li>
<li><a href="#where-to-submit-security-issues"
id="toc-where-to-submit-security-issues">Where to submit security
issues?</a></li>
<li><a href="#how-to-detect-new-security-issues"
id="toc-how-to-detect-new-security-issues">How to detect new security
issues?</a></li>
<li><a href="#what-are-the-criteria-for-computing-severity"
id="toc-what-are-the-criteria-for-computing-severity">What are the
criteria for computing severity?</a>
<ul>
<li><a href="#types-of-attackers" id="toc-types-of-attackers">Types of
attackers</a></li>
<li><a href="#types-of-attacks" id="toc-types-of-attacks">Types of
attacks</a></li>
<li><a href="#severity" id="toc-severity">Severity</a></li>
<li><a href="#best-practices-for-computing-cvss"
id="toc-best-practices-for-computing-cvss">Best practices for computing
CVSS</a></li>
</ul></li>
<li><a href="#how-long-does-it-take-to-fix-a-security-issue"
id="toc-how-long-does-it-take-to-fix-a-security-issue">How long does it
take to fix a security issue?</a></li>
<li><a href="#when-is-a-security-issue-considered-as-fixed"
id="toc-when-is-a-security-issue-considered-as-fixed">When is a security
issue considered as fixed?</a></li>
<li><a href="#are-security-issues-ever-publicly-disclosed"
id="toc-are-security-issues-ever-publicly-disclosed">Are security issues
ever publicly disclosed?</a></li>
<li><a href="#how-long-does-it-take-to-publish-a-cve"
id="toc-how-long-does-it-take-to-publish-a-cve">How long does it take to
publish a CVE?</a></li>
<li><a href="#how-do-i-know-if-i-need-to-upgrade"
id="toc-how-do-i-know-if-i-need-to-upgrade">How do I know if I need to
upgrade?</a></li>
<li><a href="#vulnerabilities-in-cryptpad-dependencies"
id="toc-vulnerabilities-in-cryptpad-dependencies">Vulnerabilities in
CryptPad dependencies</a></li>
<li><a href="#security-advisory-template-and-information"
id="toc-security-advisory-template-and-information">Security Advisory
template and information</a></li>
</ul>
</aside>
...
<!-- TOC --><a name="what-are-the-available-channels-to-discuss-security-issues"></a>
...
<!-- TOC --><a name="github-security-advisories"></a>
...
<!-- TOC --><a name="best-practices-for-computing-cvss"></a>
...
<!-- TOC --><a name="user-interaction"></a>
#### User Interaction

There are no specific best practice for this: the official definition and
examples should be used to define the value.

<!-- TOC --><a name="confidentiality-impact"></a>
...
<!-- TOC --><a name="availability-impact"></a>
#### Availability Impact

There are no specific best practice for this: the official definition and
examples should be used to define the value.

<!-- TOC --><a name="how-long-does-it-take-to-fix-a-security-issue"></a>
...
<!-- TOC --><a name="when-is-a-security-issue-considered-as-fixed"></a>
...
<!-- TOC --><a name="are-security-issues-ever-publicly-disclosed"></a>
...
<!-- TOC --><a name="how-long-does-it-take-to-publish-a-cve"></a>
...
<!-- TOC --><a name="how-do-i-know-if-i-need-to-upgrade"></a>
...
<!-- TOC --><a name="vulnerabilities-in-cryptpad-dependencies"></a>
...
<!-- TOC --><a name="security-advisory-template-and-information"></a>
